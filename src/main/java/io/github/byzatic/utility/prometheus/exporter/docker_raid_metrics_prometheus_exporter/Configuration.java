...
public class Configuration {
    ...
    public static final String MEGACLI_READER_MODE;
    public static final Path MEGACLI_CONTENT_FILE_PATH;
    public static final Path MEGACLI_LOCK_FILE_PATH;
    public static final Path MEGACLI_APP_PATH;
    ...
    static {
        try {
            ...
            MEGACLI_READER_MODE = config.getString("megacliReaderMode");
            MEGACLI_APP_PATH = Paths.get(config.getString("megacliAppPath"));
            MEGACLI_CONTENT_FILE_PATH = Paths.get(config.getString("megacliContentFilePath"));
            MEGACLI_LOCK_FILE_PATH = Paths.get(config.getString("megacliLockFilePath"));
